...
int main(int argc, char ** argv) {
    ...
    consola("GUARDAR_PAGINA 1 3 2222222222222222222222222222222222222222222222222222222222222222", 0);
    consola("GUARDAR_PAGINA 1 4 3333333333333333333333333333333333333333333333333333333333333333", 0);
    consola("GUARDAR_PAGINA 1 5 4444444444444444444444444444444444444444444444444444444444444444", 0);
    consola("GUARDAR_PAGINA 1 2 3333333333333333333333333333333333333333333333333333333333333333", 0);
