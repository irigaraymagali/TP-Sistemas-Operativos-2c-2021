...
pthread_mutex_t m_list_mutex,mutex_anashe, iteration_mutex,utilizacionDePagina_mutex,list_tables_mutex;
...
void read_from_memory(int processId,int inicio, int tamanio, void* loQuieroMeter);
